...
async def upload(bot: Client, m: Message):
    ...
    credit = "️[@SONICKUWALSSCBOT](https://t.me/Tushar0125)"
    if raw_text3 == '1':
        CR = '[@SONICKUWALSSCBOT](https://t.me/Tushar0125)'
    elif raw_text3:
        try:
